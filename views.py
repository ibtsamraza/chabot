...
#os.environ["COHERE_API_KEY"] = "RH6qvMwnXfKhHvMOdBzA63mu5MvjPyei2KSMndei"
def start_llm():
    os.environ["COHERE_API_KEY"] = "JeI9k5imzInt6wGKzUMhQjF0cRno2PUQLuRywn5E"
    ...
    # os.environ["HUGGINGFACEHUB_API_TOKEN"] = "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"
    #llm = HuggingFaceEndpoint(repo_id="meta-llama/Meta-Llama-3-8B-Instruct", task="text-generation",
     #                          temperature=0.2, max_new_tokens=300, huggingfacehub_api_token="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")
    llm=ChatGroq(temperature=0.2 ,model="llama-3.1-70b-versatile",groq_api_key="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")
    print("\nAPI Running!\n")
